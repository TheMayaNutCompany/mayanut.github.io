...
- **Commerce-forward landing experience** (store preview + future storefront)
- **Brand hub** for MayaNut and The MayaNut Company
- **Research + reference pages** for those who want depth
- **Gallery + field documentation** (nursery, trees, fruit, product concepts)

Primary fieldwork and trials are based in **South Florida, USA**.
...
- **HTML5** — structure + semantic SEO
- **CSS3** — layout, responsiveness, brand styling
- **Vanilla JavaScript** — UI logic (menus, overlays, search/filter, toggles)
